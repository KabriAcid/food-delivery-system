...
<head>
    ...
    <title>Dishes || Online Food Delivering System - Deliver </title>
                            ...
                            <div class="widget-body">
                                ...
                                ?>
                                    ...
                                    <div class="form-group row no-gutter">
                                        <div class="col-xs-8">
                                            <input type="text" class="form-control b-r-0" value=<?php echo "&#8358;" . number_format($item["price"], 2); ?> readonly id="exampleSelect1">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                ?>
                                    ...
                                    <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check" class="btn btn-danger shadow-lg disabled">Checkout</a>

                                <?php
                                } else {
                                ?>
                                    <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check" class="btn btn-success shadow-lg active">Checkout</a>
                                <?php
                                }
                                ?>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-8">
                                                <form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                                    ...
                                                    <div class="rest-descr">
                                                        ...
                                                        <p class="mb-0"> <?php echo $product['slogan']; ?></p>
                                                        <span class="price" style="font-size:1.2rem;font-weight:800;color:var(--primary-color)">&#8358;<?php echo number_format($product['price'], 2); ?></span>
                                                    </div>
