...
?>
    ...
    <head>
        ...
        <title>Checkout || Online Food Delivering System - Deliver </title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-color" style="font-size: 1.3rem;color: var(--primary-color);"><strong> <?php echo "&#8358;" . number_format($item_total, 2); ?></strong></td>
                                                            </tr>
                                                        </tbody>
                                            ...
                                            <div class="payment-option">
                                                ...
                                                <p class="text-xs-center"> <input type="submit" onclick="return confirm('Do you want to confirm the order?');" name="submit" class="btn btn-block" value="Order Now" style="background-color: var(--primary-color);color:white;"> </p>
                                            </div>
                                </form>
                            </div>
                        </div>
