                                                    ...
                                                    <table id="myTable" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                    ...
                                                                    ?>
                                                                        <td> <button type="button" class="btn btn-sm btn-info"><span class="fa fa-bars" aria-hidden="true"></span> Dispatch</button></td>
                                                                    <?php
                                                                    }
                                                                    if ($status == "in process") { ?>
                                                                        <td> <button type="button" class="btn btn-sm btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> On The Way!</button></td>
                                                                    <?php
                                                                    }
                                                                    if ($status == "closed") {
                                                                    ?>
                                                                        <td> <button type="button" class="btn btn-sm btn-primary"><span class="fa fa-check-circle" aria-hidden="true"></span> Delivered</button></td>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                    <?php
                                                                    if ($status == "rejected") {
                                                                    ?>
                                                                        <td> <button type="button" class="btn btn-sm btn-danger"> <i class="fa fa-close"></i> Cancelled</button></td>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                    <?php
